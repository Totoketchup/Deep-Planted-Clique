python main.py -c ../data/kdd_datasets/mutag -l ../data/kdd_datasets/mutag.Labels -b 255 -d 512 --wlk_h 3 -e 1000 -lr 0.5
...
python main.py -c ../data/kdd_datasets/nci107 -l ../data/kdd_datasets/nci109.Labels -b 1204 -d 512 --wlk_h 3 -e 1000 -lr 0.5
